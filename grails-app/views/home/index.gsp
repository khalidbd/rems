...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.7/dashboard_5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 07:19:19 GMT -->
<head>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"><span>
                        ...
                        <img alt="image" class="img-circle" src="img/khalid_pp.jpg"/>
                    </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><span class="block m-t-xs"><strong
                                    class="font-bold">${applicationContext.springSecurityService.currentUser.displayName}</strong>
                ...
                <li class="active">
                    <a href="index-2.html"><i class="fa fa-th-large"></i> <span
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li>
                        <a href="${createLink(controller: 'logout')}"><li>
