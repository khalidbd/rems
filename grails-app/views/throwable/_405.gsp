...
<head>
    ...
    <title><g:message code="default.title.404" default="IBCS Reporting Tool | 404 Page not found"/></title>
    <!-- favicon -->
            ...
            <div class="error-page">
                ...
                <div class="error-content">
                    ...
                    <p>
                        ...
                        Meanwhile, you may <a
                            href="${request.contextPath}/">return to dashboard</a> or try using the search form.
                    </p>
