		...
		<div id="list-requestMap" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="requestMap.createdBy.label" default="Created By" /></th>
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'requestMap.dateCreated.label', default: 'Date Created')}" />
						...
						<th><g:message code="requestMap.modifiedBy.label" default="Modified By" /></th>
				...
				<g:each in="${requestMapInstanceList}" status="i" var="requestMapInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: requestMapInstance, field: "modifiedBy")}</td>
