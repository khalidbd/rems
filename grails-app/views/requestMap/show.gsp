	...
	<body>
		...
		<div id="show-requestMap" class="content scaffold-show" role="main">
			...
			<ol class="property-list requestMap">
				...
				<li class="fieldcontain">
					<span id="createdBy-label" class="property-label"><g:message code="requestMap.createdBy.label" default="Created By" /></span>
					
						<span class="property-value" aria-labelledby="createdBy-label"><g:link controller="user" action="show" id="${requestMapInstance?.createdBy?.id}">${requestMapInstance?.createdBy?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${requestMapInstance?.dateCreated}">
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="requestMap.dateCreated.label" default="Date Created" /></span>
					
						<span class="property-value" aria-labelledby="dateCreated-label"><g:formatDate date="${requestMapInstance?.dateCreated}" /></span>
				...
				<li class="fieldcontain">
					<span id="modifiedBy-label" class="property-label"><g:message code="requestMap.modifiedBy.label" default="Modified By" /></span>
					
						<span class="property-value" aria-labelledby="modifiedBy-label"><g:link controller="user" action="show" id="${requestMapInstance?.modifiedBy?.id}">${requestMapInstance?.modifiedBy?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${requestMapInstance?.dateModified}">
				<li class="fieldcontain">
					<span id="dateModified-label" class="property-label"><g:message code="requestMap.dateModified.label" default="Date Modified" /></span>
					
						<span class="property-value" aria-labelledby="dateModified-label"><g:formatDate date="${requestMapInstance?.dateModified}" /></span>
